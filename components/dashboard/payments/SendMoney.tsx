                ...
                <>
                    ...
                    <div className="bg-white/5 rounded-2xl p-6 border border-white/10 mb-8">
                        ...
                        <div className="mt-6">
                            ...
                            <input type="text" value={itccCode} onChange={e => setItccCode(e.target.value)} className={`w-full bg-black/20 border rounded-xl py-3 px-4 text-sm text-white placeholder-gray-600 focus:ring-1 transition-all uppercase font-mono tracking-wider ${itccCode && isItccValid(itccCode) ? 'border-green-500/50 focus:border-green-500 focus:ring-green-500' : 'border-white/10 focus:border-yellow-400 focus:ring-yellow-400'}`} placeholder="Optional at this step" />
                        </div>
                    </div>
                    ...
                    <div className="w-full max-w-lg bg-[#1e293b] border border-red-500/30 rounded-2xl shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <div className="p-6 pb-0">
                            <div className="flex flex-col items-center text-center mb-6">
                                ...
                                <p className="text-gray-400 text-xs mt-3 leading-relaxed max-w-sm">International Transaction Control Code (ITCC) is missing. This transfer is restricted until verification is provided.</p>
                            </div>
                        ...
                        <div className="overflow-y-auto p-6 pt-0">
                            ...
                            <button onClick={() => setShowComplianceModal(false)} className="w-full text-center text-gray-500 text-xs mt-4 hover:text-white transition-colors pb-2">Cancel Transfer</button>
                        </div>
                    </div>
                </div>
            )}
